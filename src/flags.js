    ...
    },
    {
        ...
        target: {
            ...
            symbols: [
                ...
                // Gamma Crucis (Top) - 1/6 down from top
                { type: 'star', color: 'white', points: 7, innerRadius: 0.4, radius: 1 / 14, xOffset: 0.25, yOffset: -1 / 3 },
                // Alpha Crucis (Bottom) - 1/6 up from bottom
                { type: 'star', color: 'white', points: 7, innerRadius: 0.4, radius: 1 / 14, xOffset: 0.25, yOffset: 1 / 3 },
                // Beta Crucis (Left) - 1/4 left, 1/16 up
                { type: 'star', color: 'white', points: 7, innerRadius: 0.4, radius: 1 / 14, xOffset: 0.125, yOffset: -1 / 16 },
                // Delta Crucis (Right) - 2/9 right, 31/240 up
                { type: 'star', color: 'white', points: 7, innerRadius: 0.4, radius: 1 / 14, xOffset: 0.25 + 1 / 9, yOffset: -31 / 240 },
                // Epsilon Crucis (Small, 5pt) - 1/10 right, 1/24 down
                { type: 'star', color: 'white', points: 5, innerRadius: 0.38, radius: 1 / 24, xOffset: 0.30, yOffset: 1 / 24 },
            ]
        }
    },
    {
